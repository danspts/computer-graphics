...
\begin{document}
    ...
    \begin{enumerate}
        ...
        $\iff \lambda_1 \begin{bmatrix} 1 \\ 4 \\ 3 \end{bmatrix} + \lambda_2 \begin{bmatrix} 1 \\ 0 \\ -1 \end{bmatrix} = \begin{bmatrix} 0 \\ 8 \\ 8 \end{bmatrix} $

        $\iff \lambda_1 = -\lambda_2 = 2$

        Now we plug in!

        $p_0 = \ell_2(-2) = \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix} + (-2) \begin{bmatrix} 1 \\ 4 \\ 3 \end{bmatrix}$
        $=(1 - 2(1), 1 - 2(4), 1 - 2(3)) = (-1, -7, -5)$
